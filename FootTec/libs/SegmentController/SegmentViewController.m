...
- (void)addButtonInScrollHeader:(NSArray *)titleArray
{
    ...
    for (NSInteger index = 0; index < titleArray.count; index++) {
        ...
        segmentBtn.frame = CGRectMake(MainScreenWidth/2 * index, 0, MainScreenWidth/2, self.buttonHeight);
    ...
    _lineView = [[UIView alloc] initWithFrame:CGRectMake(0, self.buttonHeight - self.bottomLineHeight, MainScreenWidth/2, self.bottomLineHeight)];
...
- (void)didSelectSegmentIndex:(NSInteger)index
{
    ...
    rect.origin.x = (index - HEADBTN_TAG) * MainScreenWidth/2;
