//
//  CompleteToShopOrderViewController.swift
//  FootTec
//
...
class CompleteToShopOrderViewController: BaseUIViewController,UITableViewDelegate,UITableViewDataSource {
...
extension CompleteToShopOrderViewController{
    ...
    func requestData(isHeader:Bool){
        ...
        FootTecRequest.getMyCompleteOrder(technician_id: uid, style: "0", page: page, successResponse: {
            if isHeader {
